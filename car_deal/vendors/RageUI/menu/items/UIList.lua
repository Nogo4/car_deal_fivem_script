            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if Enabled == true or Enabled == nil then
                    if Selected then
                        ...
                        RenderText(ListText, CurrentMenu.X + SettingsList.Text.X + 10 + CurrentMenu.WidthOffset - RightOffset, CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsList.Text.Scale, 255, 255, 255, 255, 2)
                    else
                        ...
                        RenderText(ListText, CurrentMenu.X + SettingsList.Text.X + 10 + CurrentMenu.WidthOffset - RightOffset, CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsList.Text.Scale, 153, 153, 153, 255, 2)
                    end
                else
